package com.xymn.basic.expressinfo.entity;
 ...
 */
@Entity
@Table(name = "express_info", schema = "")
@SuppressWarnings("serial")
public class ExpressInfoEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="EXPRESS_CODE",nullable=true,length=50)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  快递鸟编码
	 */
	@Column(name ="KUAIDINIAO_CODE",nullable=true,length=50)
