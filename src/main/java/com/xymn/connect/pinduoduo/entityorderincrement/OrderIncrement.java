package com.xymn.connect.pinduoduo.entityorderincrement;
...
public class OrderIncrement {
	...
	/**商品集合*/
	private OrderIncrementGoods[] item_list;
	...
	public OrderIncrementGoods[] getItem_list() {
		return item_list;
	}

	public void setItem_list(OrderIncrementGoods[] item_list) {
