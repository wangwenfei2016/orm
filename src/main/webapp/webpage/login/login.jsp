      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            ...
            <h4 class="blue" id="id-company-text" style="width: 637px;">物流监控系统</h4>
          </div>
          ...
          <div class="position-relative">
            ...
            <div class="center"><h6 class="blue" id="id-company-text">系统账号开通可联系客服QQ:55889720</h6></div>
