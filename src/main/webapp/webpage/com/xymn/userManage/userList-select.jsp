...
<div class="easyui-layout" fit="true">
	...
	<t:datagrid name="userList" title="common.user.select" actionUrl="tSUserController.do?datagrid" fitColumns="true" idField="id" queryMode="group"  checkbox="true"  sortName="createDate" sortOrder="desc" onLoadSuccess="initCheck">
