	...
	<table style="width: 500px" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
			...
			<tr>
				...
				<td class="value"><t:upload name="jfcl" buttonText="选择签名" queueID="test" multi="false" uploader="tSUserController.do?savesign" extend="pic" id="file_upload" formData="formobj"></t:upload></td>
			</tr>
		</tbody>
	</table>
</t:formvalid>
